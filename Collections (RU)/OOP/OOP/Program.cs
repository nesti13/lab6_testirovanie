    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (Car car in select)
            {
                ...
                e_c_Power.InnerText = $"{car._yana._Power}";
                XmlNode e_c_Volume = XDoc.CreateElement("Volume");
                e_c_Volume.InnerText = $"{car._yana._Volume}";
                XmlNode e_c_Type = XDoc.CreateElement("Type");
                e_c_Type.InnerText = $"{car._yana._Type}";
                XmlNode e_c_Serial_number = XDoc.CreateElement("Serial_number");
                e_c_Serial_number.InnerText = $"{car._yana._Serial_number}";
            ...
            XDoc.Save("C:\\Users\\Admin\\Desktop\\testir\\laba6\\test-doc.xml");
            ...
            XDoc1.Save("C:\\Users\\Admin\\Desktop\\testir\\laba6\\Collections (RU)\\OOP\\OOP\\exe1.xml");
            ...
            XDoc2.Save("C:\\Users\\Admin\\Desktop\\testir\\laba6\\Collections (RU)\\OOP\\OOP\\exe2.xml");
        }
    }
}
